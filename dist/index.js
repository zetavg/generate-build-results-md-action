...
function generateBuildResultsMd(buildResultsArray) {
    const errors = [];
    const items = [];
    buildResultsArray.forEach((buildResult, index) => {
        if (typeof buildResult !== 'object' || buildResult === null) {
            errors.push(`Invalid build result at index ${index}, expected Object, got ${buildResult}`);
            return;
        }
        const buildResultObj = buildResult;
        switch (buildResultObj.type) {
            case 'ios': {
                try {
                    ...
                    errors.push(`Error processing iOS build result at index ${index}: ${e instanceof Error ? e.message : e}`);
                    return;
                }
                break;
            }
...
exports["default"] = generateBuildResultsMd;
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
function getBuildResultsArrayFromJson(buildResultsJson) {
    ...
    const buildResultsArray = Array.isArray(buildResults)
        ...
        : typeof buildResults === 'object'
            ...
            : (() => {
                throw new Error(`Invalid build results, expected Array or Object, got ${buildResults}`);
            })();
    return buildResultsArray;
}
exports["default"] = getBuildResultsArrayFromJson;
...
const getBuildResultsArrayFromJson_1 = __importDefault(__nccwpck_require__(2672));
const generateBuildResultsMd_1 = __importDefault(__nccwpck_require__(6952));
/**
...
async function run() {
    try {
        const buildResultsJson = core.getInput('build-results-json');
        const buildResultsArray = (0, getBuildResultsArrayFromJson_1.default)(buildResultsJson);
        const [buildResultsMd, errorMessages] = (0, generateBuildResultsMd_1.default)(buildResultsArray);
        ...
        core.setOutput('build-results-md-json-text', JSON.stringify(buildResultsMd).slice(1, -1));
    }
    catch (error) {
